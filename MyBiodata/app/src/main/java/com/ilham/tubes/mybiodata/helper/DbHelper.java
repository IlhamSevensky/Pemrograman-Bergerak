...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<HashMap<String, Object>> getAllData() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                map.put(COLUMN_MAJOR, cursor.getString(5));
                map.put(COLUMN_STUDY_PROGRAM, cursor.getString(6));
                wordList.add(map);
    ...
    public void insert(String name, int age, String gender, String address, String major, String study_program) {
        SQLiteDatabase database = this.getWritableDatabase();
        String insertQuery = "INSERT INTO " + TABLE_NAME + " (name, age, gender, address, major, study_program)" + " VALUES ('" + name + "'," + age + ",'" + gender + "','" + address + "','" + major + "','" + study_program + "')";
    ...
    public void update(int id, String name, int age, String gender, String address, String major, String study_program) {
        SQLiteDatabase database = this.getWritableDatabase();
